                        ...
                        <div className="mt-8 space-y-6">
                            {rituals.map((ritual, index) => {
                                ...
                                return (
                                    <section
                                        key={ritual.title}
                                        className="rounded-[1.25rem] border border-ink-3/30 bg-[hsl(var(--ink-1))]/55 p-5"
                                    >
                                        <div className="flex flex-wrap items-start justify-between gap-4">
                                            <div className="flex items-start gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <h2 className="mt-1 text-xl font-semibold text-ink-8">{ritual.title}</h2>
                                                </div>
                                            </div>
                                        ...
                                        <ul className="mt-5 space-y-3">
                                            {ritual.steps.map((step) => (
                                                <li key={step} className="flex items-start gap-3 text-sm leading-7 text-ink-6">
                                        ...
                                        <div className="mt-5 rounded-2xl bg-[hsl(var(--card))] p-4">
                                            ...
                                            <p className="mt-2 text-sm leading-7 text-ink-6">{ritual.whyItWorks}</p>
                                        </div>
                                    </section>
                                );
                            })}
