    ...
    <div className="mm-auth">
      ...
      <main className="mm-auth__form-panel">
        ...
        >
          ...
          {/* Google first — one tap, no email-confirmation interstitial, so
              it is the lowest-friction door into a first conversation. */}
          <motion.button
            variants={item}
            type="button"
            className="mm-btn-outline mm-btn-outline--lead"
            onClick={onGoogle}
...
/* Lead placement (above the email form): slightly stronger presence while
   staying inside the locked palette and Google's light-button guidelines. */
.mm-btn-outline--lead {
