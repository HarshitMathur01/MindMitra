  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      {[0, 1, 2].map((i) => (
        <motion.div
          ...
          style={{
            width: 120 + i * 40,
            height: 50 + i * 15,
            background: `radial-gradient(ellipse, rgba(55,48,80,0.9), rgba(30,25,50,0.7))`,
            top: 10 + i * 20,
            left: -30 + i * 60,
            filter: "blur(6px)",
          }}
      ...
      {Array.from({ length: 20 }).map((_, i) => (
        <motion.div
          key={`rain-${i}`}
          className="absolute w-[1.5px] rounded-full bg-blue-300/40"
          style={{
...
export default function MoodWeather({ onAvatarCue }: MoodWeatherProps) {
  ...
  return (
    <ToolShell
      ...
      completed={completed}
      onReset={handleReset}
      themeColor="from-[#00171f] via-[#003459] to-[#001d2d]"
    >
            ...
            >
              ...
              <div className="relative">
                ...
                <div
                  ...
                  className={cn(
                    "relative w-full aspect-square rounded-2xl border border-white/10 cursor-crosshair overflow-hidden",
                ...
                >
                  ...
                  {/* Quadrant labels */}
                  <span className="absolute top-3 left-3 text-[10px] text-white/20 font-medium uppercase tracking-wider">
                    🌫 Foggy
                  </span>
                  <span className="absolute top-3 right-3 text-[10px] text-white/20 font-medium uppercase tracking-wider">
                    ☀️ Sunny
                  </span>
                  <span className="absolute bottom-3 left-3 text-[10px] text-white/20 font-medium uppercase tracking-wider">
                    ⛈ Stormy
                  </span>
                  <span className="absolute bottom-3 right-3 text-[10px] text-white/20 font-medium uppercase tracking-wider">
                    ⚡ Electric
                  </span>

                  {/* Axis labels */}
                  <span className="absolute -left-0.5 top-1/2 -translate-y-1/2 -rotate-90 text-[9px] text-white/15 uppercase tracking-widest">
                    Mood →
                  </span>
                  <span className="absolute bottom-0.5 left-1/2 -translate-x-1/2 text-[9px] text-white/15 uppercase tracking-widest">
                    Energy →
                  </span>
                  ...
                  {pin && (
                    ...
                    >
                      <div className="relative">
                        <div className="w-5 h-5 rounded-full bg-teal-400 border-2 border-white shadow-lg shadow-teal-500/40" />
                        <motion.div
              ...
              <AnimatePresence>
                {confirmed && currentQuadrant && (
                  <motion.div
                    ...
                    style={{
                      background: `linear-gradient(135deg, ${QUADRANT_META[currentQuadrant].color}10, transparent)`,
                    }}
                  >
            ...
            >
                ...
                <div className="grid grid-cols-10 gap-1.5">
                  {last30.map(({ date, entry }) => {
                    ...
                    return (
                      <div
                        key={date}
                        className="aspect-square rounded-lg border border-white/[0.04] flex items-center justify-center"
                        style={{
                          background: meta ? `${meta.color}18` : "rgba(255,255,255,0.02)",
                        }}
              ...
              <div className="grid grid-cols-7 gap-1">
                {["S", "M", "T", "W", "T", "F", "S"].map((d, i) => (
                  <div
                    key={i}
                    className="text-center text-[10px] text-white/25 py-1"
                  >
                    {d}
                  </div>
                ))}
                ...
                {calDays.map((cell, i) => {
                  ...
                  if (cell === null) {
                    return (
                      <div
                        key={`empty-${i}`}
                        className="aspect-square rounded-lg bg-white/[0.02] border border-white/[0.03] flex items-center justify-center"
                      >
