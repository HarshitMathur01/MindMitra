          ...
          <>
            ...
            >
              <div className="max-w-4xl mx-auto">
                ...
                {(isProcessing || isRecording || currentTranscript) && (
                  <div className="mt-3">
                    {isProcessing && (
                      <div className="p-3 bg-blue-100 text-blue-700 rounded-lg text-sm border border-blue-200 text-center">
                        <div className="flex items-center justify-center gap-2">
                          <Volume2 className="w-4 h-4 animate-spin" />
                          🎤 Analyzing voice and generating insights...
                        </div>
                      </div>
                    )}
                    ...
                    {isRecording && (
                      <div className="p-3 bg-green-100 text-green-700 rounded-lg text-sm border border-green-200 text-center">
                        <div className="flex items-center justify-center gap-2 mb-2">
                          ...
                          <span className="font-semibold">Recording ({recordingDuration}s)</span>
                          <div className="w-3 h-3 bg-red-500 rounded-full animate-pulse"></div>
                        </div>
                ...
                {/* Voice-Enhanced Message Indicator */}
                {messages.some(msg => msg.metadata?.voice_aware) && (
                  <div className="mt-2">
                    <div className="text-xs text-blue-600 bg-blue-50 p-2 rounded border border-blue-200 text-center">
                      🎤 Voice-enhanced responses are active - your emotional tone is being considered
                    </div>
                  </div>
                )}
