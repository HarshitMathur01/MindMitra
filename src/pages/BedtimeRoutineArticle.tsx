    ...
    return (
        <div className="min-h-screen bg-background text-foreground transition-colors duration-300">
            ...
            <main className="mx-auto flex w-full max-w-5xl flex-col gap-10 px-4 py-8 sm:px-6 lg:px-8">
                <section className="overflow-hidden rounded-[32px] border border-border/50 bg-gradient-to-br from-[#EFF6FF] via-white to-[#F5F3FF] shadow-[0_24px_60px_rgba(15,23,42,0.08)]">
                ...
                <section className="grid gap-6 md:grid-cols-[1.2fr_0.8fr]">
                    ...
                    <aside className="space-y-5">
                        <section className="rounded-[28px] border border-border/50 bg-white p-6 shadow-[0_18px_40px_rgba(15,23,42,0.06)]">
                            <h2 className="text-lg font-semibold text-slate-900">A simple order to follow</h2>
                        ...
                        <section className="rounded-[28px] border border-border/50 bg-gradient-to-br from-primary/8 to-violet-50 p-6 shadow-[0_18px_40px_rgba(15,23,42,0.06)]">
                            <h2 className="text-lg font-semibold text-slate-900">Be gentle with yourself</h2>
