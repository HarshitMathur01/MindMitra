...
2. `docs/README.md` — doc hub; then `docs/architecture.md` or `docs/backend/ARCHITECTURE.md` for lifecycle detail  
...
| Memory retrieval / trigger interval changes require **`docs/MEMORY.md`** and/or **`docs/backend/MEMORY_ARCHITECTURE.md`** | Ops and eval alignment |
...
- **Docs:** clarity > length; link to `docs/README.md` instead of duplicating architecture prose.
...
- Giant copy-paste from LLM output into ARCHITECTURE.md without integrating links in `docs/README.md`.  
