  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background text-foreground transition-colors duration-300 relative overflow-hidden">
      ...
      >
        ...
        >
          <div className="w-24 h-24 mx-auto bg-gradient-to-br from-blue-100 to-purple-100 dark:from-primary/20 dark:to-primary/10 rounded-full flex items-center justify-center">
            <Compass className="h-12 w-12 text-primary" />
          </div>
          <motion.div
            className="absolute -top-2 -right-2 w-8 h-8 bg-pink-100 dark:bg-surface rounded-full flex items-center justify-center"
        ...
        {/* Gentle suggestion */}
        <motion.div
          className="bg-crushed-silk/60 backdrop-blur-sm rounded-xl border border-border p-4 text-sm text-muted-foreground"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
